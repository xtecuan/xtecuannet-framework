 ...
 * @author xtecuan
 */
public final class CFCFEntitiesFiller implements TemplaterFiller {

    public static final String TEMPLATE_NAME = "cfcBeanEntityLike.ftl";
    private static final Logger logger = Logger.getLogger(CFCFEntitiesFiller.class);
