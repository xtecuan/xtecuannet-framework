 ...
 */
package com.googlecode.xtecuannet.framework.model.locator;
...
public final class Locator {
    ...
    public Object lookup(String jndiName, boolean ejb) {
        Object out = null;
        try {
            out = ic.lookup(jndiName);
        } catch (NamingException ex) {
            logger.error("Error in lookup: " + jndiName, ex);
        } finally {
